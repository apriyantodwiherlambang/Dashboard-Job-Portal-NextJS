...
import { JOBSTYPES } from "@/constants";
import InputSkills from "@/components/organisms/InputSkills/index";
    ...
    <div>
      ...
      <Form {...form}>
        ...
        >
              ...
              render={({ field }) => (
                <FormItem className="space-y-3">
                  <FormControl>
                    ...
                    >
                      {JOBSTYPES.map((item: string, i: number) => (
                        <FormItem
                          key={item + i}
          ...
          <FieldInput
            title="Nice-To-Haves"
            subtitle="Add nice-to-hace skills and qualifications for the role to encourage a more diverse set of candidates to apply"
          >
            <CKEditor
              form={form}
              name="niceToHaves"
