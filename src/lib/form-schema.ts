...
export const jobFormSchema = z.object({
  ...
  benefits: z
    ...
    .nonempty({ message: "Benefits must be at least 1 benefit" }), // Menambahkan nonempty untuk memastikan bahwa array tidak kosong
});
...
export const overviewFormSchema = z.object({
  ...
  description: z.string({ required_error: "Description About Company is required" }),
});
