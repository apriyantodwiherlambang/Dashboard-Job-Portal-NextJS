    ...
    <div>
          ...
          <div>
            ...
            <div className="text-gray-500 mt-3">
              <p>
                ...
                dolore repellat cupiditate blanditiis esse odio perferendis et
                laudantium quisquam. Nisi labore hic voluptatum iure vitae sit
                quos officiis ipsa cumque!
              </p>
            </div>
          </div>
        ...
        <div>
          ...
          <div className="mb-10 space-y-5">
            <div className="flex justify-between">
              ...
              <div className="font-semibold">19 Mar 2024</div>
            </div>
          </div>
          ...
          <div className="mb-10 space-y-5">
            <div className="flex justify-between">
              ...
              <div className="font-semibold">19 Feb 2024</div>
            </div>
          </div>
      ...
      <div className="grid grid-cols-4 gap-5 mt-9">
        {[0, 1, 2].map((item: number) => (
          <div key={item}>
            <PartyPopperIcon className="w-10 h-10 text-promary mb-6" />
