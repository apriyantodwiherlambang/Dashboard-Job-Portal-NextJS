//import { supabaseGetOublicURL } from "@/lib/supabase";
import Image from "next/image";
import { ChangeEvent, useEffect, useRef, useState } from "react";

interface CustomeUploadProps {
  form: any;
  name: string;
}

export default function CustomUpload({ form, name }: CustomeUploadProps) {
  ...
  return (
    <>
      ...
      <div
        className="py-6 px-10 border-2 cursor-pointer border-bluePrimary w-max rounded-sm"
